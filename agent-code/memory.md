...
4.  該 n8n 已經啟動了
5.  在 AI 圖像辨識的介面上增加一個 template 連結供使用者下載（URL: `https://img.swingyoyo.com/rp-scoring-final-template.pdf`）。
6.  對齊按鈕顏色，維持 UI 一致性。
7.  在 UI 上補充並潤飾說明文字：
...
**決策：將「自動偵測產生評分表」更名為「AI 圖像辨識」**
- 理由：讓使用者更清楚明白這是上傳圖片並透過 AI 進行辨識的功能。
- i18n 規劃：
  - ZH-TW: "AI 圖像辨識"
